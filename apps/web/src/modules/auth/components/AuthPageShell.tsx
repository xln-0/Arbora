...
export default function AuthPageShell({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-surface-muted px-5 py-8 sm:px-8">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl overflow-hidden rounded-[2rem] border border-white/80 bg-surface shadow-[0_24px_80px_rgba(15,23,42,0.10)] lg:grid-cols-[0.9fr_1.1fr]">
        <section className="flex flex-col justify-between bg-gradient-to-br from-primary-hover via-primary to-teal-500 p-8 text-white sm:p-12">
          <div>
